...
project = u'Django Admin Extra-Urls'
...
# of the sidebar.
#html_logo = '_static/pasport_logo.gif'
...
htmlhelp_basename = 'admin_extra_urls'
...
latex_documents = [
    ('index', 'admin_extra_urls.tex', u"Django Admin Extra-urls Documentation",
...
man_pages = [
    ('index', 'admin_extra_urls', u"Django Admin Extra-urls",
